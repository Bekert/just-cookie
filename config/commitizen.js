module.exports = {
  types: [
    ...
    { value: "refactor", name: "refactor:  Fix code without addition new features" },
    { value: "docs", name: "docs:      Update docs" },
    { value: "revert", name: "revert:    Back to previous commits" },
    { value: "style", name: "style:     Codestile edits (tabs, dots, semicolons etc)" },
    { value: "ci", name: "build:     Changes to our CI configuration files and scripts (just nothing)" },
